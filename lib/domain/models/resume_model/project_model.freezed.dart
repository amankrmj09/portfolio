...
mixin _$ProjectModel {
 ...
 String get name; List<String> get techStack; String get duration; String get description;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProjectModel&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.techStack, techStack)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.description, description) || other.description == description));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,const DeepCollectionEquality().hash(techStack),duration,description);

@override
String toString() {
  return 'ProjectModel(name: $name, techStack: $techStack, duration: $duration, description: $description)';
}
...
@useResult
$Res call({
 String name, List<String> techStack, String duration, String description
});
...
/// Create a copy of ProjectModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? techStack = null,Object? duration = null,Object? description = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  List<String> techStack,  String duration,  String description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProjectModel() when $default != null:
return $default(_that.name,_that.techStack,_that.duration,_that.description);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  List<String> techStack,  String duration,  String description)  $default,) {final _that = this;
switch (_that) {
case _ProjectModel():
return $default(_that.name,_that.techStack,_that.duration,_that.description);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  List<String> techStack,  String duration,  String description)?  $default,) {final _that = this;
switch (_that) {
case _ProjectModel() when $default != null:
return $default(_that.name,_that.techStack,_that.duration,_that.description);case _:
  return null;
...
class _ProjectModel implements ProjectModel {
  const _ProjectModel({required this.name, required final  List<String> techStack, required this.duration, required this.description}): _techStack = techStack;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProjectModel&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other._techStack, _techStack)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.description, description) || other.description == description));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,const DeepCollectionEquality().hash(_techStack),duration,description);
...
/// Create a copy of ProjectModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? techStack = null,Object? duration = null,Object? description = null,}) {
